 ...
 *   - D = annual demand (derived as avgDailyDemand * 365)
 ...
 * @param {number} [daysPerYear=365] - Days to annualize demand.
...
function calculateEOQ(historicalDemand, orderCost = 100, holdingCost = 10, daysPerYear = 365) {
